...
$results_page=$categoryController->getCategoriesPage($page);
$items_per_page=5;
?>
                            ...
                            <table class="table table-striped" >
                                ...
                                <?php
                                    ...
                                    for($row=0;$row<count($results_page);$row++)
                                    {
                                        ...
                                        echo "<td>". $results_page[$row]['name']."</td>";
                                        ...
                                        else
                                        {
                                           ...
                                           {
                                            if($results_page[$row]['parent']==$categories[$index]['id'])
                                            {
                                        ...
                                        echo "<td id='".$results_page[$row]['id']."'><a href='edit_category.php?id=".$results_page[$row]['id']."' class='btn btn-warning mr-3'>Edit</a><a class='btn btn-danger delete'>Delete</a></td>";
                                        echo "</tr>";
                                    }
